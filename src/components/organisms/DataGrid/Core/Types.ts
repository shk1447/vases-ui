...
export interface Column<TRow, TSummaryRow = unknown> {
  ...
  readonly formatter?: Maybe<
    (props: FormatterProps<TRow, TSummaryRow>) => ReactNode
  >;
  ...
  readonly groupFormatter?: Maybe<
    (props: GroupFormatterProps<TRow, TSummaryRow>) => ReactNode
  >;
  /** Enables cell editing. If set and no editor property specified, then a textinput will be used as the cell editor */
  readonly editable?: Maybe<boolean | ((row: TRow) => boolean)>;
  readonly colSpan?: Maybe<
    (args: ColSpanArgs<TRow, TSummaryRow>, colIndex?: number) => Maybe<number>
  >;
  ...
  readonly headerRenderer?: Maybe<
    (props: HeaderRendererProps<TRow, TSummaryRow>) => ReactNode
  >;
}
...
export interface RowRendererProps<TRow, TSummaryRow = unknown>
  ...
  onRowClick: Maybe<
    (row: TRow, column: CalculatedColumn<TRow, TSummaryRow>, e?: any) => void
  >;
...
export interface Renderers<TRow, TSummaryRow> {
  ...
  >;
  rowRenderer?: Maybe<
    (key: Key, props: RowRendererProps<TRow, TSummaryRow>) => ReactNode
  >;
  groupRowRenderer?: Maybe<
    (key: Key, props: GroupRowRendererProps<TRow, TSummaryRow>) => ReactNode
  >;
