...
interface CalculatedColumnsArgs<R, SR>
  extends Pick<DataGridProps<R, SR>, "defaultColumnOptions"> {
...
export function useCalculatedColumns<R, SR>({
  ...
  const defaultFormatter = defaultColumnOptions?.formatter ?? DefaultFormatter;
    ...
    useMemo((): {
      ...
      const columns = rawColumns.map((rawColumn) => {
        ...
        const column: Mutable<CalculatedColumn<R, SR>> = {
          ...
          rowGroup,
          width: rawColumn.hide ? 0 : rawColumn.width ?? defaultWidth,
          minWidth: rawColumn.hide ? 0 : rawColumn.minWidth ?? defaultMinWidth,
          maxWidth: rawColumn.hide ? 0 : rawColumn.maxWidth ?? defaultMaxWidth,
